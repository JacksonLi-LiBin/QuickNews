...
public class FangchanFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener, OnSliderClickListener {
	...
	private Handler handler = new Handler(new Callback() {
		...
		public boolean handleMessage(Message msg) {
			...
			case 0:
				...
				try {
					getMyActivity().setCacheStr("FangchanFragment" + currentPage, result);
					if (isRefresh) {
						isRefresh = false;
						newsAdapter.clear();
						listModles.clear();
	...
	void initView() {
		...
		loadData(getCommonUrl(index + "", Url.FangChanId));
	...
	private void loadData(String url) {
		if (getMyActivity().hasNetWork()) {
			...
			String result = getMyActivity().getCacheStr("FangchanFragment" + currentPage);
