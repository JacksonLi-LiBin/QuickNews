...
public class XiaohuaFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener, OnSliderClickListener {
	...
	private Handler handler = new Handler(new Callback() {
		...
		public boolean handleMessage(Message msg) {
			...
			case 0:
				...
				try {
					getMyActivity().setCacheStr("XiaohuaFragment" + currentPage, result);
					if (isRefresh) {
						isRefresh = false;
						newsAdapter.clear();
						listModles.clear();
	...
	private void loadData(String url) {
		if (getMyActivity().hasNetWork()) {
			...
			String result = getMyActivity().getCacheStr("XiaohuaFragment" + currentPage);
